...
> **This repo is `learn-with-will/clean-architecture`** — so `SLUG` = `clean-architecture`, and the finished course goes live at
> `https://learn-with-will.github.io/clean-architecture/`.
